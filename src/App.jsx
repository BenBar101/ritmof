...
export default function App() {
  ...
  return (
    <AppContext.Provider value={ctx}>
      <GlobalStyles />
      <div style={{ height: "100dvh", display: "flex", flexDirection: "column", background: "#000", color: "#fff", overflow: "hidden", ...(isReloading ? { pointerEvents: "none", userSelect: "none" } : {}) }}>
        {isReloading && (
          <div
        ...
        <div data-scroll="" style={{ flex: 1, overflowY: "auto", overflowX: "hidden" }}>
